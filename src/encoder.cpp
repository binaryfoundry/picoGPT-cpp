...
std::vector<int> BPEEncoder::encode(const std::string& text) {
...
std::string BPEEncoder::decode(const std::vector<int>& tokens) {
...
std::string BPEEncoder::bpe(const std::string& token) {
    // Check cache
